    ...
    function login() {
      $logged_in = json_decode(json_encode(json_decode($this->input->cookie('logged_in'))), true);
        ...
        if ($this->form_validation->run() == TRUE)
        {
            ...
            {
                $logged_in_user = json_decode(json_encode(json_decode($this->input->cookie('logged_in'))), true);
                redirect(base_url());
            }
        }
        ...
        $this->load->view("../../assets/themes/default/login.php", $data);
    }
