...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->isAppMobile  = $detect->isMobile();
        ...
        // get current user
        $this->user = json_decode(json_encode(json_decode($this->input->cookie('logged_in'))), true);
        ...
        $this
            ->add_external_css(
                array(
                    ...
                    base_url("/{$this->settings->themes_folder}/core/plugins/jquery-ui.min.css"),
                    base_url("/{$this->settings->themes_folder}/core/plugins/datatables.min.css"),
                    base_url("/{$this->settings->themes_folder}/core/plugins/boostrap-select.css"),
            ...
            ->add_external_js(
                array(
                    ...
                    base_url("/{$this->settings->themes_folder}/core/plugins/jquery-ui.min.js"),
                    base_url("/{$this->settings->themes_folder}/core/plugins/datatables.min.js"),
                    base_url("/{$this->settings->themes_folder}/core/plugins/jquery-validation/jquery.validate.min.js"),
                    base_url("/{$this->settings->themes_folder}/core/plugins/notify.min.js"),
                    base_url("/{$this->settings->themes_folder}/core/plugins/boostrap-select.js"),
                    base_url("/{$this->settings->themes_folder}/core/js/common.js")
