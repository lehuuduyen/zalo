...
class DeclareController extends AdminController
{
    ...
    public function exportExcel()
    {
        ...
        foreach ($order as $key => $row) {
            ...
            $row->last_time_updated = date('d/m/Y H:i:s', strtotime($row->last_time_updated));
    ...
    public function exportExcelKH()
    {
        ...
        foreach ($order as $key => $row) {
            ...
            $object->getActiveSheet()
                ...
                ->getNumberFormat()
                ->setFormatCode('#,##0');
            $object->getActiveSheet()->setCellValueByColumnAndRow(9, $excel_row, $phi);
            $object->getActiveSheet()
                ->getStyle('J' . $excel_row)
                ->getNumberFormat()
                ->setFormatCode('#,##0');
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(15, $excel_row, $row->receiver);
            $object->getActiveSheet()->setCellValueExplicit("Q" . $excel_row, $row->phone, PHPExcel_Cell_DataType::TYPE_STRING);
            $object->getActiveSheet()->setCellValueByColumnAndRow(17, $excel_row, $row->address);
            $object->getActiveSheet()->setCellValueByColumnAndRow(18, $excel_row, $row->ward);
            $object->getActiveSheet()->setCellValueByColumnAndRow(19, $excel_row, $row->district);
            $object->getActiveSheet()->setCellValueByColumnAndRow(20, $excel_row, $row->city);
            $object->getActiveSheet()->setCellValueByColumnAndRow(21, $excel_row, $row->note);
            $object->getActiveSheet()->setCellValueByColumnAndRow(22, $excel_row, $row->warehouses);
            $object->getActiveSheet()->setCellValueByColumnAndRow(23, $excel_row, $row->product);
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(26, $excel_row, $row->city_send);
            $object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->date_debits);
            $object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $name_region);
