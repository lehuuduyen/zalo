...
class Convert_model extends CI_Model
{
    ...
    public function active($string)
    {
        ...
        if(isset($formatProvince[$province_id])){
    ...
    public function getDistrict($province_id,$string)
    {
        ...
        foreach ($purchases as $value){
            ...
            if (stripos($string, $district) !== false) {
                ...
                $string =$this->str_replace_first($district,'',$string);
        ...
        foreach ($listDistrict as $codeDistrict){
            if(count($this->getCommune($codeDistrict,$string,$province_id))>0){
                $getCommune[$codeDistrict]=$this->getCommune($codeDistrict,$string,$province_id)[0];
            }
        }
