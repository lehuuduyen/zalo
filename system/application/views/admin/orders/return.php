            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <h4 style="color:red">TRẢ HÀNG CHO SHOP</h4>
                        </div>
...
<script>
    ...
    function searchOrder() {
        ...
        if (order != "") {
            ...
            $.ajax({
                url: "/system/api/return/payment_table?data=" + data, success: function (result) {
...
<!--                    <button  class="btn btn-success" onclick="printOrderReturn('-----')">Xuất Excel</button>-->
    ...
    function loadTableDetail($maPhieu = "",confirm=false) {
        ...
        let linkApi = '/system/api/return/table_detail?jsonData=' + JSON.stringify(data);
    ...
    function printOrderReturnPdf(codeReturn) {
        let linkApi = '/system/return/print_pdf?code_return=' + codeReturn;
        window.open(linkApi)
