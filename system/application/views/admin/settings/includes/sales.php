...
<div class="tab-content">
   <div role="tabpanel" class="tab-pane active" id="general">
      ...
      <?php echo render_input('settings[debt_start]','Giá trị công nợ ban đầu đã đối soát', get_option('debt_start'), 'number', ['required'=>true]); ?>

      <?php echo render_input('settings[debt_start]','Giá trị công nợ ban đầu đợi đối soát', get_option('debt_control_start'),'number', ['required'=>true]); ?>
      <hr />
