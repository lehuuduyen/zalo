...
<div id="wrapper">
    <div class="panel_s mbot10 H_scroll" id="H_scroll">
        <div class="panel-body _buttons">
            ...
            <a href="<?= base_url('admin/stock/add_exporting_production') ?>" class="btn btn-info pull-right H_action_button">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-stock" class="table dt-tnh table-hover table-bordered table-condensed table-stock dont-responsive-table dataTable" style="width: 100%;">
                                <thead>
                                    <tr>
	...
	$(document).ready(function() {
		oTable = tnhDatatable(
            '#table-stock',
            {
                ...
                // autoWidth: true,
                "serverSide": true,
                'sAjaxSource': '<?= site_url('admin/stock/getExportingProductions') ?>',
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        ...
                        "targets": 3, "name": 'reference_stock', 'width': '150px'
                    },
                    {"targets": 4, "name": 'reference_no', 'width': '150px'},
                    {
                        "render": function(data, type, row) {
                            type = row[11];
                            // label = 'success';
                            ...
                            return '<div class="mbot5">'+data+'</div>';
                        },
                        "targets": 5, "name": 'reference_production_detail', 'width': '150px'
                    },
                    {"targets": 6, "name": 'export_name', 'width': '100px'},
                    {"targets": 7, "name": 'warehouse_name', 'width': '100px'},
                    ...
                    {"targets": 12, "name": 'type', 'visible': false},
                    {
                        "render": function(data, type, row) {
                            if (!data) {
                                return '<a href="javascript:void(0)" onclick="" class=" btn btn-info btn-icon " data-toggle="tooltip" data-loading-text="Xin vui lòng đợi..." data-original-title="Thủ kho duyệt"><i class="fa  fa-square-o"></i> Chưa duyệt kho</a>';
                            }
                            return data;
                        },
                        "targets": 13, "name": 'status_warehouse'
                    },
                    {"targets": 14, "name": 'actions', 'searchable': false, 'sortable': false, 'width': '50px'},
                ]
            }
        );

        $(document).on('click', '#table-stock_wrapper .btn-dt-reload', function(event) {
            oTable.draw('page');
        });
