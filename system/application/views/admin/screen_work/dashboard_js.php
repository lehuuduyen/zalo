        ...
        $("[data-container]").sortable({
            ...
            update: function (event, ui) {
                if (this === ui.item.parent()[0]) {
                    ...
                    $.post(admin_url + 'screen_work/save_dashboard_widgets_screen_work_customer', data, "json");
                }
            }
        });
...
<!-- hổ trợ css -->
<script>
$(".wap-center").click(function(e) {
  var i;
  var currentInput = $(e.currentTarget);
  var active = currentInput.hasClass('active');
  var unactive = currentInput.hasClass('unactive');
  if(active) {
    currentInput.removeClass('active');
    currentInput.addClass('unactive');
  }
  else if(unactive) {
    currentInput.removeClass('unactive');
