            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="row-custom ghtk-show">
                        ...
                        <div class="col-md-9">
                            <h2 style="font-size: 30px; font-weight: bold; color: red; float: right">Tạo Đơn Hàng Giao
                                Hàng Tiết Kiệm</h2>
                        </div>
                    </div>
...
<div class="modal fade" id="default_value" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <?php echo form_open(admin_url('create_order_ghtk/add_default'), array('id' => 'create_order_default')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                ...
                <div class="form-group ">
                    <label for="token_ghtk">Token Giao Hàng Tiết Kiệm </label>
    ...
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="id_default" value="<?php echo $id_default ?>">
                <div class="form-group ">
                    <label for="mass_default">Mã trạng thái của GHTK</label>
                    <input type="text" class="form-control" placeholder="Trạng thái của GHTK" id="status_ghtk"
                           name="status_ghtk" value="<?= set_value('status_ghtk') ?>">
                    <a href="https://docs.giaohangtietkiem.vn/#tr-ng-th-i-n-h-ng26" target="_blank">Tra mã của GHTK</a>
                </div>
                <div class="form-group ">
    ...
    function setValidGHTK() {
        ...
        $("#create_order_ob").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: '/system/admin/create_order_ghtk/add_ghtk',
                    data,
                    type: 'POST',
                    success: function (data) {
                        $('.overlay-dark').hide();
