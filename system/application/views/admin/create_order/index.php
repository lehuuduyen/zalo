                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <?php if (has_permission('staff', '', 'create')) { ?>
                            <div class="_buttons">
                                <a data-type="sps" style="margin-right:10px;" href="javascript:;"
                        ...
                        <div id="debts_customer" class="">
                            <div class="row">
                                ...
                                <div class="col-md-12 total_calc_cover">
                                    ...
                                    <button class="btn btn-success mtop25" type="button" id="btn-export-excel">Tạo Đối
                                        Soát Ứng COD
                                    </button>
...
<div class="modal fade" id="create_order" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('create_order/add'), array('id' => 'create_order_ob', 'autocomplete' => 'off')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="row-custom">
                        <div class="col-md-5">
                            <div class="form-group" style="position:relative">
                                ...
                                <input autocomplete="off" placeholder="Chọn Khách Hàng" onkeyup="enterSupership(event)" class="form-control"
                    ...
                    <div class="row-custom">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeyup="enterSupership(event)"  placeholder="Sản Phẩm" id="product"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeyup="enterSupership(event)"  placeholder="Điện Thoại" id="ap" name="ap"
                            ...
                            <div class="form-group phone-more" style="display:none">
                                ...
                                <input type="text" class="form-control" onkeyup="enterSupership(event)" placeholder="Điện Thoại Phụ" id="phone_more"
                                       name="phone_more"/>
                            </div>
                            <!-- Phone More-->
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" onkeyup="enterSupership(event)" placeholder="Họ Và Tên" id="f" name="f"/>
                            </div>
                            <!-- Họ Và Tên-->
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" onkeyup="enterSupership(event)" placeholder="Địa Chỉ" id="a" name="a"
                                       autocomplete="off"/>
                            </div>
                            <!-- Địa Chỉ-->
                    ...
                    <div class="row-custom">
                        <div class="col-md-2">
                            <div class="form-group ">
                                ...
                                <input style="color:red;font-weight:bold;" onkeyup="formatNumBerKeyUp(this);enterSupership(event)" type="text"
                        ...
                        <div class="col-md-2">
                            <div class="form-group ">
                                ...
                                <input onkeyup="formatNumBerKeyUp(this);enterSupership(event)" type="text" class="form-control"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Ghi Chú Nội Bộ" style="resize:none; height:100px;"
                                          class="form-control" rows="5" id="note_private" name="note_private"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="row-custom ghtk-show">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="config">Token GHTK:</label>
                                <input type="text" class="form-control" onkeyup="enterSupership(event)" id="token_ghtk" name="token_ghtk" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12" style="margin-bottom:10px;">
                            ...
                            <h2 style="font-size: 30px; font-weight: bold; color: red; float: right;margin-top: 0px">Tạo Đơn Hàng SuperShip</h2>
                        </div>
                        ...
                        <div class="more-config ">
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" onkeyup="enterSupership(event)" placeholder="Mã Đơn Của Shop" id="soc"
                                           name="soc"/>
...
<div class="modal fade" id="default_value" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <?php echo form_open(admin_url('create_order/add_default'), array('id' => 'create_order_default')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
