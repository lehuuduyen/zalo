...
<div class="modal fade" id="create_order" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('create_order_bestinc/add_vnc'), array('id' => 'create_order_ob', 'autocomplete' => 'off')); ?>
...
<div class="modal fade" id="default_value" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <?php echo form_open(admin_url('create_order_bestinc/add_default'), array('id' => 'create_order_default')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
    ...
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="id_default" value="<?php echo $id_default ?>">
                <div class="form-group ">
                    <label for="mass_default">Trạng Thái Của VNC</label>
                    <input type="text" class="form-control" placeholder="Trạng Thái Của VNC" id="status_ghtk"
                           name="status_ghtk" value="<?= set_value('status_ghtk') ?>">
                    <a href="https://docs-apiv2.viettelpost.vn" target="_blank">Tra mã của VNC</a>
                </div>
                <div class="form-group ">
...
<script type="text/javascript">
    ...
    $(document).on('click', '#customer_local', function (e) {
        ...
        if ($(this).prop('checked')) {
            ...
            $.ajax({
                url: '/system/admin/create_order_bestinc/check_customer_policy_exits/' + getLocalCustomer.customer_id,
                method: 'GET',
    ...
    $(document).on('change', '#province', function () {
        ...
        if (val) {
            ...
            district = '';
            $.ajax({
                url: '/system/admin/create_order_bestinc/get_district_by_hd/' + val.code,
                method: 'GET',
    ...
    function setValidGHTK() {
        ...
        $("#create_order_ob").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: '/system/admin/create_order_bestinc/add_vnc',
                    data,
                    type: 'POST',
                    success: function (data) {
                        $('.overlay-dark').hide();
                        ...
                        if (JSON.parse(data).success === 'ok') {
                            ...
                            $('.print-order').attr('href', '/system/admin/create_order_ghtk/print_data_order/' + JSON.parse(data).id + '?print=true&dv=VNC');
    ...
    $(document).on('click', '.search-item li', function (e) {
        ...
        $.ajax({
            url: '/system/admin/create_order_bestinc/check_customer_policy_exits/' + id,
            method: 'GET',
            success: function (check) {
                $('#special').empty();
                ...
                success: function (data) {
                    ...
                    if (data) {
                        ...
                        if (data.status == '200') {
                            ...
                            $.ajax({
                                url: `/system/admin/create_order_bestinc/search_region?province=${province}&district=${district}&policy_id=${policy_id}`,
                                method: 'GET',
                                success: function (region) {
