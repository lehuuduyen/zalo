...
?>
<script>
    var token_ghtk = "<?php echo empty($default_data->token_ghtk) ? 0:$default_data->token_ghtk; ?>";
    var address_id = "<?php echo (empty($default_data->address_id)) ? 0:$default_data->address_id; ?>";
</script>
<div id="wrapper">
...
<div class="modal fade" id="create_order" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?php echo form_open(admin_url('create_order_ghtk/add'), array('id' => 'create_order_ob', 'autocomplete' => 'off')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="row-custom">
                        <div class="col-md-5">
                            <div class="form-group" style="position:relative">
                                ...
                                <input autocomplete="off" placeholder="Chọn Khách Hàng"  onkeyup="enterGhtk(event)" class="form-control"
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb0">
                                <input name="customer_local" onkeyup="enterGhtk(event)" id="customer_local" type="checkbox" value="">
                    ...
                    <div class="row-custom">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeyup="enterGhtk(event)" placeholder="Sản Phẩm" id="product"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" onkeyup="enterGhtk(event)" placeholder="Điện Thoại" id="ap" name="ap"
                            ...
                            <div class="form-group phone-more" style="display:none">
                                ...
                                <input type="text" class="form-control" onkeyup="enterGhtk(event)" placeholder="Điện Thoại Phụ" id="phone_more"
                                       name="phone_more"/>
                            </div>
                            <!-- Phone More-->
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" onkeyup="enterGhtk(event)" placeholder="Họ Và Tên" id="f" name="f"/>
                            </div>
                            <!-- Họ Và Tên-->
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" onkeyup="enterGhtk(event)" placeholder="Địa Chỉ" id="a" name="a"
                                       autocomplete="off"/>
                            </div>
                            <!-- Địa Chỉ-->
                    ...
                    <div class="row-custom">
                        <div class="col-md-2">
                            <div class="form-group ">
                                ...
                                <input style="color:red;font-weight:bold;" onkeyup="formatNumBerKeyUp(this);enterGhtk(event)" type="text"
                        ...
                        <div class="col-md-2">
                            <div class="form-group ">
                                ...
                                <input onkeyup="formatNumBerKeyUp(this);enterGhtk(event)" type="text" class="form-control"
                    ...
                    <div class="row-custom ghtk-show">
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="hidden" class="form-control"
                                       value="<?php echo $default_data->token_ghtk ?>" id="token_ghtk" name="token_ghtk"
                                       required>
                        ...
                        <div class="col-md-9">
                            <h2 style="font-size: 30px; font-weight: bold; color: red; float: right">Tạo Đơn Hàng Giao Hàng Nội Bộ</h2>
                        </div>
                    </div>
                        ...
                        <div class="more-config ">
                            ...
                            <div class="col-md-2">
                                <div class="form-group ">
                                    ...
                                    <input type="text" onkeyup="enterGhtk(event)" class="form-control" placeholder="Mã Đơn Của Shop" id="soc"
                                           name="soc"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="config">Chọn Phương Tiện Giao Hàng:</label>
                                    <select class="form-control" id="transport" name="transport">
                                        <option value="road">Giao Hàng Đường Bộ</option>
                                        <option value="fly">Giao Hàng Đường Không</option>
                                    </select>
                                </div>
                            </div>
...
<div class="modal fade" id="default_value" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <?php echo form_open(admin_url('create_order_nb/add_default'), array('id' => 'create_order_default')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                ...
                <div class="form-group " style="display:none;">
                    <label for="token_ghtk">Token </label>
                    <input type="text" class="form-control" placeholder="Token Giao Hàng Tiết Kiệm" id="token_ghtk"
    ...
    <div class="modal-dialog" role="document" style="width:80%;margin:auto;margin-top:50px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="id_default" value="<?php echo $id_default ?>">
                <div class="form-group ">
                    <label for="mass_default">Mã trạng thái của NB</label>
                    <input type="text" class="form-control" placeholder="Trạng thái của NB" id="status_ghtk"
...
<script type="text/javascript">
    ...
    $(document).on('click', '#customer_local', function (e) {
        ...
        if ($(this).prop('checked')) {
            ...
            $.ajax({
                url: '/system/admin/create_order_ghtk/check_customer_policy_exits/' + getLocalCustomer.customer_id,
                method: 'GET',
    ...
    function setValidSPS() {
        $("#create_order_ob").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: '/system/admin/create_order_ghtk/add',
                    data,
                    type: 'POST',
                    success: function (data) {
                        $('.overlay-dark').hide();
...
//
                            $('.print-order').attr('href', '/system/admin/create_order_ghtk/print_data_order/' + JSON.parse(data).id + '?print=true');
    ...
    function setValidGHTK() {
        ...
        $("#create_order_ob").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: '/system/admin/create_order_nb/add_nb',
                    data,
                    type: 'POST',
                    success: function (data) {
                        $('.overlay-dark').hide();
                        ...
                        if (JSON.parse(data).success === 'ok') {
                            ...
                            $('.print-order').attr('href', '/system/admin/create_order_ghtk/print_data_order/' + JSON.parse(data).id + '?print=true&dv=NB');
    ...
    $('.open-modal-addnew').click(function () {
        ...
        if (token_ghtk == '' || address_id == '') {
            alert('Khai Báo Đầy đủ thông tin địa chỉ và token');
            $('#default_value').modal('show');
            return false;
        }
        var w = window.innerWidth;
    ...
    $(document).on('click', '.search-item li', function (e) {
        ...
        $.ajax({
            url: '/system/admin/create_order_ghtk/check_customer_policy_exits/' + id,
            method: 'GET',
            success: function (check) {
                $('#special').empty();
    ...
    function fnChangeStatus() {
        ...
        if (status_ghtk.length > 3) {
            alert('Độ dài trạng thái của giao hàng tiết kiệm không được lớn hơn 3 ký tự!');
            $("#status_ghtk").focus();
            return false;
        }
