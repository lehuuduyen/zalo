				 	...
				 	<?php 
												...
												<td>
													<div class="form-group">
										                <div class="input-group">
										                    ...
										                    <?php echo (isset($items) ? ($items->prefix) : get_option('prefix_detail_up'));?></span>
															<?php 
						...
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 mbot50">
							<div class="panel panel-warning">
								<div class="panel-heading"><?=_l('Mặt hàng cần điều chỉnh tăng')?></div>
								<div class="panel-body">
									...
									<!-- <table class="table items item-adjusted no-mtop dont-responsive-table"> -->
										<thead>
											<tr>
                                                ...
                                                <th style="width: 120px" class="text-center"><?php echo _l('Số lượng điều chỉnh tăng'); ?></th>
						...
						<table class="table tnh-tb noMargin table-color_sum dont-responsive-table">
							<tbody>
								<tr>
									...
									<td>
										<span class="bold"><?php echo _l('Tổng số lượng điều chỉnh tăng'); ?> :</span>
									</td>
									<td class="total_net">
		    ...
		    var total = 0;
		   	function createTrItem(data,type)
			    ...
			    $(document).on('keyup', '.mainQuantityNet', (e)=>{
			        ...
			        {
			        	alert('Nhập số lượng tăng lớn hơn 0!');
			        ...
			        var handling=Number(mainQuantityNet)+Number(quantity.val());
