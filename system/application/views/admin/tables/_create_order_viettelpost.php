...
foreach ($rResult as $aRow) {
    ...
    if (is_admin()) {
        ...
        $icon_print_new = '<a href="/system/admin/create_order_ghtk/print_data_order/'.$aRow['id'] .'?print=true&dv=VTP" class="btn btn-default btn-icon" target="_blank">
        <i class="fa fa-print"></i>
        </a>';
