...
foreach ($rResult as $aRow) {
    ...
    $row[] = $_data;
    $row[] ='<div>
                <a class="tnh-modal btn btn-success btn-icon edit-item-group" ><i class="fa fa-pencil"></i></a>
                <a href="'.admin_url('invoice_items/delete_group/'.$aRow['id']).'"  type="button" class="btn btn-danger po btn-icon delete-remind_gb" data-container="body" data-html="true" data-toggle="popover" data-placement="left"
