...
$string_filter = "AND dvvc = 'VNC' AND status_cancel != '1' AND created <= '".$_POST['date_end_customer']."'"." AND created >= '".$_POST['date_start_customer']. "'". " ";
...
foreach ($rResult as $aRow) {
    ...
    if (is_admin()) {
        $icon_delete = '<a href="/system/admin/create_order_bestinc/delete/'.$aRow['id'] .'" class="btn btn-danger delete-reminder-custom btn-icon">
        <i class="fa fa-remove"></i>
        </a>';

        $icon_print = '<a href="/system/admin/create_order_ghtk/print_data_order/'.$aRow['id'] .'?print=true&dv=VNC" class="btn btn-primary btn-icon" target="_blank">
