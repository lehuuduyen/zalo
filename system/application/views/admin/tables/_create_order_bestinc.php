...
$string_filter = "AND dvvc = 'VNC' AND created <= '" . $_POST['date_end_customer'] . "'" . " AND created >= '" . $_POST['date_start_customer'] . "'" . " ";
...
foreach ($rResult as $aRow) {
    ...
    if (is_admin()) {
        ...
        $icon_print_new = '<a href="/system/admin/create_order_ghtk/print_data_order/'.$aRow['id'] .'?print=true&dv=VNC" class="btn btn-default btn-icon" target="_blank">
        <i class="fa fa-print"></i>
        </a>';
