...
if(!empty($_POST['csrf_protection']) || !empty($_GET['csrf_protection']) ||
    (!empty(file_get_contents('php://input'))
        && (
            (!is_array(file_get_contents('php://input')) && !empty(json_decode(file_get_contents('php://input'))->csrf_protection))
            || (is_array(file_get_contents('php://input')) && !empty(file_get_contents('php://input')->csrf_protection))
        )
    )
) {
