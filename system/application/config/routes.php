...
// Webhook GHTK
$route['webhook/ghtk'] = 'api/webhook_ghtk';

$route['add_status'] = 'api/add_status';
...
$route['api/order/district'] = 'admin/Order/getDistrict';
$route['api/order'] = 'admin/Order/getList';
$route['api/order_tab4'] = 'admin/Order/getListTab4';
$route['api/order/export_excel'] = 'admin/Order/exportExcel';
$route['api/order/export_excel_kh'] = 'admin/Order/exportExcelKH';
$route['api/get_region_by_city'] = 'admin/Order/getRegionByCity';
$route['api/order/update'] = 'admin/Order/edit';

//payment
$route['api/return/table_detail'] = 'admin/Returns/getTableDetail';
$route['api/return/print_excel'] = 'admin/Returns/printExcel';
$route['return/print_pdf'] = 'admin/Returns/printPdf';
$route['api/return/payment_table'] = 'admin/Returns/getPaymentTable';
