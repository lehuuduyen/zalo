...
*
*/
define('APP_BASE_URL', 'http://spshd.com/system/');
...
*/
define('APP_ENC_KEY', '94437fd03aab001c5ed136a40bbe46e6');
 ...
 */
define('APP_DB_USERNAME', 'admin_spshd');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'spshd');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'admin_spshd');
