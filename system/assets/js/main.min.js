...
$('body').on('click', '._delete-reminder,._delete-remind', function() {
    var r = confirm(app.lang.confirm_action_prompt);
    if (r == false) {
        return false;
    } else {
        var x = confirm(app.lang.confirm_action_prompt);
        if (x == false) {
            return false;
        }
        var c = confirm(app.lang.confirm_action_prompt);
        if (c == false) {
            return false;
        }
...
$("#menu").hover(function(){
  ...
  $('#side-menu li a').css('display','block');
}, function(){
    $('#wrapper').css('margin-left','50px');
    $('#side-menu li a').css('display','flex');
...
function initDataTableDungbt(selector, url, notsearchable, notsortable, fnserverparams, defaultorder , height = 'auto') {
    ...
    var length_options = [1, 2, 3, 4];
    var length_options_names = [1, 2, 3, 4];
...
function initDataTableDungbt2(selector, url, notsearchable, notsortable, fnserverparams, defaultorder , text = '') {
    ...
    var dtSettings = {
        ...
        "initComplete": function(settings, json) {
            ...
            var totalHtml = `<span style="float: left;margin-top: 33px;margin-left: 10px;" class="total_label">${text}</span><span class="btn btn-default total_cal">${formatNumber(json.calc_total_s_e)}</span>`;
            $('.total-append').empty();
