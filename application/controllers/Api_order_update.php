...
class Api_order_update extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($q as $key => $value) {
            $sta = $this->get_api_replace($value->code_supership, $value->id, $value->date_debits, $value->shop, $value->status, $value->mass);
    ...
    public function get_api_replace($code = '', $id = '', $date_debits, $shop = '', $status_before, $weight)
    {
        $is_hd_branch = false;
