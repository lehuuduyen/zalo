...
<!---->
<!--<table id="example" class="stripe row-border order-column table-clients" style="width:100%">-->
<!--    <thead>-->
<!--    <tr>-->
<!--        <th>First name</th>-->
<!--        <th>Last name</th>-->
...
<script>
    ...
    var tAPI = initDataTable('.table-all-contacts', '<?=admin_url('clients/tabletest')?>', [], [], {[csrfData['token_name']]:csrfData['hash']}, [0,'asc'], {leftColumns: 1,rightColumns: 1});
    ...
    function initDataTableFixedHeader(table, url, notsearchable, notsortable, fnserverparams, defaultorder, fixedColumns) {
        ...
        tables_pagination_limit = parseFloat(app.options.tables_pagination_limit);
