...
<div id="wrapper">
    ...
    <?php echo form_open('admin/products/import_category',array('id'=>'add-product')); ?>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
...
<script type="text/javascript">
    ...
    function checkWarning(field, row)
    {
        if (field == "code") {
            ...
            row.find('.td-note').html(textErrors('<?= lang('tnh_please_enter_code_parent') ?>'));
        } else if (field == "name") {
    ...
    $(document).ready(function() {
        ...
        function importExcel(form) {
            ...
            var url = form.action;
            $.ajax({
                url : site.base_url+'admin/products/import_category',
                type : 'POST',
                dataType: 'JSON',
                cache : false,
                contentType : false,
