				...
				<div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                    	<div class="wap-content firt">
                            ...
                            <span class="bold font-medium-xs lead-name"><?= _dt($suggest_exporting['date_convert_stock']) ?></span>
                        </div>
                        <div class="wap-content firt">
                            <span class="text-muted lead-field-heading no-mtop bold"><?= lang('tnh_reference_stock') ?>: </span>
                            <span class="bold font-medium-xs lead-name"><?= $suggest_exporting['reference_stock'] ?></span>
                        </div>
                        ...
                        <div class="wap-content firt">
                            <span class="text-muted lead-field-heading no-mtop bold"><?= lang('tnh_reference_productions_orders_details') ?>: </span>
                            <span class="bold font-medium-xs lead-name"><?= (!empty($pod) ? $pod['reference_no'] : '') ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                	<div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="wap-content firt">
                            <span class="text-muted lead-field-heading no-mtop bold"><?= lang('tnh_warehouses') ?>: </span>
                            <span class="bold font-medium-xs lead-name"><?= $warehouse['name'] ?></span>
                        </div>
                		<div class="wap-content second">
	...
	$(document).ready(function() {
		var dtItems = $('#table-items').DataTable({
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                $( api.column( 7 ).footer() ).html('<div class="text-center">'+tnhFormatNumber(pageQuantityExchange)+'</div>');
            }
		});
	});
</script>