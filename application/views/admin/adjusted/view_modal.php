  ...
  <div class="modal fade in" id="view_adjusted" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="false">
      ...
      <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">
              <?php if($items->type == 1){ ?>
              <span class="book-title"><?php echo _l('Thông tin phiếu điều chỉnh tăng'); ?> </span>
              <?php }else{?>
              <span class="book-title"><?php echo _l('Thông tin phiếu điều chỉnh giảm'); ?> </span>  
              <?php }?>
            </h4>
          </div>
                          ...
                          <div class="panel-body">
                            <div class="well well-sm">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div><b><?=_l('warehouse')?>: </b><?php echo $warehouse_name->name?></div>
                  ...
                  <table id="view-enquiry" class="table table-bordered table-hover table-color layout-fixed" width="2000">
                      <thead>
                          <tr>
                            ...
                            <?php if($items->type == 1){ ?>
                            <th class="text-center"><?php echo _l('Số lượng điều chỉnh tăng'); ?></th>
                            <?php }else{?>
                            <th class="text-center"><?php echo _l('Số lượng điều chỉnh giảm'); ?></th>  
                            <?php }?>
                  ...
                  <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                      <tbody>
                        <tr class="success">
                          ...
                          <td><?=_l('Tổng số lượng điều chỉnh')?>:<span class="pull-right"><?=number_format($total)?></span></td>
                          <td><?=_l('Tổng số lượng thực')?>:<span class="pull-right"><?=number_format($totalQuantity_time)?></span></td>
                    </tr>
                    </tbody>
                  </table>
              </div>
