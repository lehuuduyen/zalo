...
<div id="wrapper">
    ...
    <!-- <div> -->
        <div class="panel-body _buttons">
            ...
            <a href="<?= base_url('admin/items/export_excel_category') ?>" class="btn btn-info pull-right H_action_button tnh-modal" data-tnh="modal" data-toggle="modal" data-target="#myModal">
                <i class="fa fa-file-excel-o" aria-hidden="true"></i>
                <?php echo lang('tnh_export_excel'); ?>
            </a>
            <div class="line-sp"></div>
            <a href="<?= base_url('admin/items/import_category') ?>" class="btn btn-info pull-right H_action_button">
                <i class="fa fa-upload" aria-hidden="true"></i>
                <?php echo lang('tnh_import_excel'); ?>
            </a>
            <div class="line-sp"></div>
            <a href="<?= base_url('admin/items/add_category') ?>" class="btn btn-info pull-right H_action_button tnh-modal" data-tnh="modal" data-toggle="modal" data-target="#myModal">
