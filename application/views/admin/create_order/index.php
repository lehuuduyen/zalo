                ...
                <div class="row">
                    ...
                    <div class="row-custom ghtk-show">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="token_ghtk" name="token_ghtk" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12" style="margin-bottom:10px;">
                            ...
                            <h2 style="font-size: 30px; font-weight: bold; color: red; float: right">Tạo Đơn Hàng SuperShip</h2>
                        </div>
