                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-15">
                                <button class="btn btn-sm btn-primary col-md-2 button-red mr-2"
                                        onclick="searchOrder()"
                        ...
                        <div class="hidden" id="danhsach">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-15">
                                    <button class="btn btn-sm btn-primary col-md-6 button-red mr-2"
                                            onclick="confirmReturn()" style="width: 40%;">
                                        Xác Nhận Chuyển Trả Những Đơn Hàng Thỏa Mãn
                                    </button>
                                </div>
...
<script>
    ...
    function searchOrder() {
        ...
        if (order != "") {
            ...
            $.ajax({
                url: "/api/return/payment_table?data=" + data, success: function (result) {
    ...
    function confirmReturn() {
        ...
        $.ajax({
            url: "/api/return/create_order_return?data=" + JSON.parse(listId), success: function (result) {
                html += `
...
<!--                    <button  class="btn btn-success" onclick="printOrderReturn('-----')">Xuất Excel</button>-->
    ...
    function loadTableDetail($maPhieu = "",confirm=false) {
        ...
        let linkApi = '/api/return/table_detail?jsonData=' + JSON.stringify(data);
        ...
        $.ajax({
            url: linkApi, success: function (result) {
                ...
                $.each(result.table_detail, function (key, value) {
                    html += "<tr>";
                    html += `
                    <td> ${formatDateTime(value.date_return)}</td>
                ...
                if(!confirm){
                    $.each(result.table_phieu, function (key, value1) {
                        ...
                        var html = "<tr>"
                        html += `
                    <td> ${formatDateTime(value1[0].date_return)}</td>
                    ...
                    <td>${total}  </td>
                    <td>
                        <button  class="btn btn-primary" onclick="printOrderReturnPdf('${value1[0].code_return}')">In</button>
<!--                    <button  class="btn btn-success" onclick="printOrderReturn('-----')">Xuất Excel</button>-->
                    </td> `
                        html += "</tr>";
                        htmlTable1+=html;
    ...
    function printOrderReturn(codeReturn) {
        let linkApi = '/api/return/print_excel?code_return=' + codeReturn;
    ...
    function printOrderReturnPdf(codeReturn) {
        let linkApi = '/return/print_pdf?code_return=' + codeReturn;
        window.open(linkApi)
