                                ...
                                <div class="col-md-12 no-padding mb-5">
                                    ...
                                    <div class="col-sm-9 " style="display: flex">
                                        ...
                                        <input class="form-control datetimepicker-date"
                                               value="<?= (isset($_GET['search_fast'])) ? "" : $date_from ?>"
                                               id="order-from-date"
                                               type="input"> &nbsp;
                                        <input class="form-control datetimepicker-date"
                                               value="<?= (isset($_GET['search_fast'])) ? "" : $date_to ?>"
...
<script>
    ...
    function getDistrict(_this) {
        ...
        $.ajax({
            url: "/api/order/district?city=" + city, success: function (result) {
    ...
    function getLink(checkExcel = false) {
        ...
        let linkApi = '/api/order?jsonData=' + JSON.stringify(data);
        if (checkExcel) {
            linkApi = '/api/order/export_excel?jsonData=' + JSON.stringify(data)
        }
        return linkApi;
    }
