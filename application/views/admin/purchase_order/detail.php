										...
										<table style="table-layout: fixed;" class="dt-tnh table item-supplier_quotes table-bordered table-hover">
											<thead>
												<tr>
													...
													<th style="width: 100px;" class="text-left"><?php echo _l('item_unit'); ?></th>
	                                            ...
	                                            if(isset($items) && count($items->items) > 0) {
	                                                foreach($items->items as $value) {
	                                                    ...
	                                                    <tr class="sortable item">
								                            ...
								                            <select class="custom_item_select" id="custom_item_select_<?=$i?>" style="width: 200px;" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
...
<script>
    ...
    var createTrItemfist = (item) => {
        ...
        var td2 = $('<td ><input type="hidden" class="count" value="'+uniqueArray+'" /><input style="width:200px;" data-placeholder="<?=_l('dropdown_non_selected_tex')?>" class="custom_item_select" id="custom_item_select_'+uniqueArray+'" name="custom_item_select_'+uniqueArray+'" style="width: 100%">\
