...
foreach ($rResult as $aRow) {
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        elseif ($aColumns[$i] == 'type_staff') {
            $_data = !empty($aRow['type_staff']) ? 'Nhân viên chính thức' : 'Cộng tác viên';
        }
        elseif ($aColumns[$i] == 'active') {
            ...
            $_data .= ' <a href="' . admin_url('staff/member/' . $aRow['staffid']) . '">' . $aRow['lastname'] . ' ' . $aRow['firstname'] . '</a>';
