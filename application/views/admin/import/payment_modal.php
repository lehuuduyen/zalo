<div class="modal fade" id="payment" role="dialog">
 <div class="modal-dialog">
  ...
  <div class="modal-content">
        <?php 
        echo form_open(admin_url('purchase_order/pay_slip/'.$id_import), array('id' => 'payment-form'));
         ?>
        ...
        <div class="modal-body" style="height:auto">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input type="text" id="total" name="total" class="form-control " value="<?=number_format($import->totalAll_suppliers - $import->amount_paid - $import->price_other_expenses)?>" readonly>
                </div>
            </div>
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    <label for="payment" class="control-label"><?=_l('ch_total_payment')?></label>
                    <input type="text" id="votes_total" onkeyup="formatNumBerKeyUp(this)" name="payment" class="form-control " value="">
                </div>
            </div>
            <div class="clearfix">  </div>
            <div class="col-md-6 col-xs-12">
