  <div class="modal fade in" id="views_import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="false">
                          ...
                          <div class="panel-body">
                            <div class="well well-sm">
                                <div class="row">
                                    ...
                                    <?php if($items->red_invoice != 0){?>
                                      <?php $invoice = get_table_where('tblpurchase_invoice',array('id'=>$items->red_invoice),'','row'); ?>
                                    <div class="col-md-6">
                                       <div><b><?=_l('ch_code_invoice')?>: </b><?php echo $invoice->code_invoice?></div> 
                                    </div>
                                    <div class="col-md-6">
                                       <div><b><?=_l('ch_date_invoice')?>: </b><?php echo _d($invoice->date_invoice)?></div> 
                                    </div>
                                    <?php }?>
                                    <div class="clearfix"></div>
                                </div>
                      ...
                      <tbody>
                        <?php foreach ($items->items as $key => $value) { ?>
                          <tr>
                            ...
                            <td class="text-right">
                                <?php echo number_format($value['promotion_suppliers']); ?>
                            </td>
                            <td class="center">
