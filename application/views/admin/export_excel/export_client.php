...
<div class="modal fade" id="export_excel_clent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <?php echo form_open(admin_url('export_excel/action_export_client'), array('id' => 'export_form', 'enctype' => 'multipart/form-data')); ?>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title"><?= _l('cong_export_data_client') ?></h4>
            </div>
            <div class="modal-body">
                ...
                <?php
                    $listArray = [];
                ?>
                <?php $colum_fields_client = get_fields_export_excel_client(); ?>
                <?php
