		...
		<div class="row">
			...
			<div class="col-md-12">
									...
									<!-- <table class="table items item-inventory no-mtop dont-responsive-table"> -->
										<thead>
											<tr>
                                                ...
                                                <th style="width: 100px" class="text-center"><?php echo _l('Chênh lệch'); ?></th>
                                                <th style="width: 200px" class="text-center"><?php echo _l('Xử lý'); ?></th>
				...
				<div class="btn-bottom-toolbar btn-toolbar-container-out text-right">
						...
						<table class="table tnh-tb noMargin table-color_sum dont-responsive-table">
							<tbody>
								<tr>
									...
									<td>
										<span class="bold"><?php echo _l('Tổng chênh lệch'); ?> :</span>
									</td>
									<td class="total_diff">
										<?php echo $totalQuantity_approve ?>
									</td>
		            ...
		            <button class="btn btn-info pull-right form-submitersss">
		            <?php echo _l( 'submit'); ?>
		            </button>
		        </div>
			</div>
		   	...
		   	function createTrItem(data,type)
			    {
			        ...
			        var td6 = $('<td><input readonly style="width:100px" class="mainQuantityDiff H_input" type="number" name="items[' + uniqueArray + '][quantity_diff]" value="" /></td>');  
			        ...
			        $('table.item-inventory tbody').prepend(newTr);
			    ...
			    $(document).on('keyup', '.mainQuantityNet', (e)=>{
			        ...
			        var handling='';
			        if(diff>0) handling='Mặt hàng cần điều chỉnh tăng '+Math.abs(diff);
			        if(diff<0) handling='Mặt hàng cần điều chỉnh giảm '+Math.abs(diff);
			    ...
			    function refreshQuantity(){
			        ...
			        $.each(items, (index,value)=>{
			            ...
			            temp=parseFloat($(value).find('input.mainQuantityDiff').val());
