               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                     ...
                     <div class="is-not-staff<?php if(isset($member) && $member->admin == 1){ echo ' hide'; }?>">
                      ...
                      <div class="is_admin">
                        <div class="checkbox checkbox-primary">
                           ...
                           ?>
                           <input type="checkbox" value="1" name="administrator" id="administrator" <?php echo $checked; ?>>
                     ...
                     <?php echo render_input('phonenumber','staff_add_edit_phonenumber',$value); ?>
                      ...
                      <!--  thêm -->
                      <div class="form-group">
                          <label for="gender" class="control-label">Giới tính</label><br>
                          <div class="radio radio-primary radio-inline">
                              <input type="radio" name="gender" id="gender_1" value="1" <?= (!isset($member->gender) || $member->gender == 1) ? 'checked' : ''  ?>>
                              <label for="gender_1">Nam</label>
                          </div>
                          <div class="radio radio-primary radio-inline">
                              <input type="radio" name="gender" id="gender_2" value="2" <?= (isset($member->gender) && $member->gender == 2) ? 'checked' : ''  ?>>
                              <label for="gender_2">Nữ</label>
                          </div>
                      </div>
                      <?php $value = (isset($member) ? $member->bank_account : ''); ?>
                      <?php echo render_input('bank_account','Tài khoản ngân hàng',$value); ?>

                      <?php $value = (isset($member) ? _d($member->date_work) : ''); ?>
                      <?php echo render_date_input('date_work','Ngày bắt đầu làm việc',$value); ?>

                      <?php $value = (isset($member) ? _d($member->birthday) : ''); ?>
                      <?php echo render_date_input('birthday','Ngày sinh',$value); ?>
                      ...
                      <?php $value = (isset($member) ? _d($member->issued_on) : ''); ?>
                      ...
                      <div class="form-group">
                          <label for="type_staff" class="control-label">Loại nhân viên</label><br>
                          <div class="radio radio-primary radio-inline">
                              <input type="radio" name="type_staff" id="type_staff_0" value="0" <?= (isset($member->type_staff) && $member->type_staff == 0) ? 'checked' : ''  ?>>
                              <label for="type_staff_0">Cộng tác viên</label>
                          </div>
                          <div class="radio radio-primary radio-inline">
                              <input type="radio" name="type_staff" id="type_staff_1" value="1" <?= (!isset($member->type_staff) || $member->type_staff == 1) ? 'checked' : ''  ?>>
                              <label for="type_staff_1">Nhân viên chính thức</label>
                          </div>
                      </div>
                      <?php $value = (isset($member) ? $member->emergency_contact : ''); ?>
                      <?php echo render_input('emergency_contact','Liên hệ khẩn cấp',$value); ?>

                      <?php $value = (isset($member) ? $member->zalo : ''); ?>
                      <?php echo render_input('zalo','Số điện thoại đăng ký zalo',$value); ?>
