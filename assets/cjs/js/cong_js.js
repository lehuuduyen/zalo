//Init datafixheader
function initDataTableFixedColums(selector, url, notsearchable, notsortable, fnserverparams, defaultorder, fixedColumns) {
    ...
    var dtSettings = {
        ...
        "initComplete": function(settings, json) {
            ...
            $('.dt-table-loading').removeClass('dt-table-loading');
...
$('.dataTable').on('draw.dt', function(e){
    setTimeout(function(e){
        $('.DTFC_LeftBodyLiner').find('.dataTable').removeClass('dataTable');
    })
})
