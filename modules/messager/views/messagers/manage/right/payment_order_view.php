  ...
  <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">
              <span class="book-title"><?php echo _l('Phiếu thu'); ?> </span>
            </h4>
          </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 17%;">
                                    <label for="date" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Ngày nhận phiếu thu'); ?>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="date" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Đơn đặt hàng'); ?>
                                    </label>
                                </td>
                                <td>
                                    <?php if(!empty($order)){ ?>
                                    <div class="form-group">
                                        <select  data-placeholder="<?=_l('Đơn hàng') ?>" id="id_order" disabled name="id_order" class="id_order" style="width: 100%;"><option value=""></option><option selected value="<?=$order->id?>"><?=$order->prefix?><?=$order->code?></option>\
                                        </select>
                            ...
                            <tr>
                                <td>
                                    <label for="number" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Giá trị cần thu (VNĐ)'); ?>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="number" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Giá trị phiếu thu (VNĐ)'); ?>
                                    </label>
                                </td>
                                <td>
                                ...
                                <td>
                                    <label for="date" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Giá trị phiếu thu nhận được (VNĐ)'); ?>
                                    </label>
                                </td>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input  id="votes_total" <?=(!empty($order) ? (($order->currencies_id == 4) ? 'onkeyup="formatNumBerKeyUp(this)" type="text"' : 'type="number"' ) : '' )?> name="payment" class="form-control " value="<?=number_format($votes_total)?>">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <label for="date" class="control-label">
                                        <small class="req text-danger">* </small>
                                         <?php echo _l('Loại tài khoản doanh nghiệp'); ?>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="number" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Thông tin tài khoản người toán'); ?>
                                    </label>
                                </td>
                                <td>
                                ...
                                <td>
                                    <label for="date" class="control-label">
                                        <small class="req text-danger">* </small>
                                        <?php echo _l('Nội dung phiếu thu'); ?>
                                    </label>
                                </td>
                                <td>
