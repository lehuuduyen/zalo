<div id="modal_orders" class="modal fade" role="dialog">
    <style type="text/css">
        ...
        .c_guest_giving, .c_total_cost_trans, .rest_collect {
        ...
        <?php echo form_open('messager/create_orders', array('id' => 'form_create_orders')); ?>
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?=_l('cong_create_order')?></h4>
                </div>
                                                ...
                                                <table class="table-tb table-bordered table-hover dont-responsive-table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p><?=_l('cong_code_ship')?>: </p> <!-- Hình thức thanh toán -->
                                                            </td>
                                                            <td>
                                                        ...
                                                        <?php if($type != 'client'){ ?>
                                                            <tr>
                                                                <td>
                                                                    <label for="shipping[name]" class="control-label"><?= _l('cong_ship_name'); ?></label>
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                        $value = (!empty($object) ? $object->name : '');
                                                                        echo render_input('shipping[name]', '', $value)
                                                                    ?>
                                                                </td>
                                                                <td><label for="shipping[phone]" class="control-label"><?= _l('cong_phonenumber_shipping'); ?></label></td>
                                                                <td>
                                                                    <?php
                                                                    $value = (!empty($object) ? $object->phonenumber : '');
                                                                    echo render_input('shipping[phone]', '', $value);
                                                                    ?>
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <td><label for="shipping[address]" class="control-label"><?= _l('cong_address_shipping'); ?></label></td>
                                                                <td>
                                                                    <?php
                                                                        $value = (!empty($object) ? $object->address : '');
                                                                        echo render_input('shipping[address]', '', $value);
                                                                    ?>
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="panel-body">
                                                    <table class="table table-bordered width_100 dont-responsive-table mtop0 mbot0 wap-table-border">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="guest_giving" class="H_input c_guest_giving" onchange="C_formatNumBerKeyUp(this)" value="0">
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p class="total_receipts text-right">0</p> <!-- Tổng giá trị phiếu thu -->
                                                            </td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><p class="rest_collect text-right"></p></td>
                                                            <td></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="panel-body">
                                                <table class="table table-bordered width_100 dont-responsive-table mtop0 mbot0 wap-table-border">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><p class="text-right rest_collect_currency"></p></td>
                                                        <td></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
...
<script>
    ...
    {
        var id = $('#form_create_orders').find('input[name="id"]').val();
        var type = $('#form_create_orders').find('input[name="type"]').val();
        var data = {};
        if (typeof(csrfData) !== 'undefined') {
            data[csrfData['token_name']] = csrfData['hash'];
        }
    ...
    function resetCurrency() {
        ...
        var rest_collect = Number(unformatNumber($('.rest_collect').val()));
